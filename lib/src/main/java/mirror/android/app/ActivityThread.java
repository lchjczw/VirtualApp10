...
public class ActivityThread {
    ...
    public static RefObject localLOGV;
    ...
    public static RefObject<Map> mProviderRefCountMap;
    ...
    @MethodParams({ActivityClientRecord.class,Intent.class})
    public static RefMethod<Activity> performLaunchActivity;
    ...
    public static class H {
        ...
        @MethodParamsOverload(intRange1 = {1,28})
        ...
        @MethodParamsOverload(intRange1 = {-28,-(AndroidVersionConstant.Q_10)})
