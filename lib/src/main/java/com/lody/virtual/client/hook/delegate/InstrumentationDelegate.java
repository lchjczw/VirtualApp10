...
public class InstrumentationDelegate extends Instrumentation {
	public String TAG = "InstrumentationDelegate";
	...
	public boolean onException(Object obj, Throwable e) {
		VLog.e("===================在ActivityThread performLaunchActivity 异常 ================");
	...
	public void sendPointerSync(MotionEvent event) {
		VLog.d(TAG," InstrumentationDelegate  sendPointerSync  ");
		base.sendPointerSync(event);
	}
	@Override
	public void sendTrackballEventSync(MotionEvent event) {
		VLog.d(TAG," InstrumentationDelegate  sendTrackballEventSync  ");
		base.sendTrackballEventSync(event);
	}
	@Override
	public Application newApplication(ClassLoader cl, String className, Context context)
			throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		VLog.e(TAG,"=== >> newApplication ");
		...
		String primaryCpuAbi = (String) ParamsHook.invokeParameter(applicationInfo,"primaryCpuAbi");
		String secondaryCpuAbi = (String) ParamsHook.invokeParameter(applicationInfo,"secondaryCpuAbi");
		VLog.e(TAG,"files size:"+files.length+"    nativeDir is exist:"+nativeDir.exists()+"    isDirectory:"+nativeDir.isDirectory()+"    primaryCpuAbi:"+primaryCpuAbi+"    secondaryCpuAbi:"+secondaryCpuAbi);
		for (File file:files){
			VLog.i("file:"+file.getAbsolutePath());
		}
		File libSo = new File(nativeLibraryDir+File.separator+primaryCpuAbi+File.separator+"libmmkv.so");
		VLog.e(TAG,"初始化 Application nativeLibraryDir = "+nativeLibraryDir+";  libmmkv.so libSo:"+libSo.exists());
	...
	public Activity newActivity(ClassLoader cl, String className, Intent intent)
			throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		DebugKook.i("这里是在ActivityThread 的 performLaunchActivity 方法调用产生的 activity");
