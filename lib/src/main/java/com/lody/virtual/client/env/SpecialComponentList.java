...
public final class SpecialComponentList {
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N && Build.VERSION.SDK_INT < AndroidVersionConstant.Q_10) {
            VLog.e("这里由于在android 8 以后总是报错  WebViewFactory，后面项办法处理掉他");
        }else {
            VLog.e("由于android Q 在这里报错，零时解决");
        }
    }
