...
import com.lody.virtual.client.hook.controller.IVirtualController;
...
public final class VirtualCore {
    ...
    public IVirtualController getVirtualController(){
        return virtualController;
    }
    public void setVirtualController(IVirtualController virtualController){
    ...
    public void startup(Context context) throws Throwable {
        if (!isStartUp) {
            ...
            invocationStubManager.init(context);
    ...
    public void initialize(VirtualInitializer initializer) {
        android.util.Log.e("kook","initializer = "+initializer);
        if (initializer == null) {
